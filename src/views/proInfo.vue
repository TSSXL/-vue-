...
<!--                    </div>-->
<!--&lt;!&ndash;                    <div class="right wow" @mouseenter="showNav" @mouseleave="hideNav">&ndash;&gt;-->
<!--&lt;!&ndash;                        <div >ALL  Product <i class="iconfont icon-arrow-left"></i></div>&ndash;&gt;-->
<!--&lt;!&ndash;                        <div class="proList" :class="{'animated fadeInUp':active}" v-if="active">&ndash;&gt;-->
<!--&lt;!&ndash;                            <div v-for="(item,index)  in proList" :key="index" @click="getType(item.ID,item.CALLED)">&ndash;&gt;-->
<!--&lt;!&ndash;                                {{item.CALLED}}&ndash;&gt;-->
<!--&lt;!&ndash;                                <i class="iconfont icon-arrow-left"></i>&ndash;&gt;-->
<!--&lt;!&ndash;                            </div>&ndash;&gt;-->
<!--&lt;!&ndash;                        </div>&ndash;&gt;-->
<!--&lt;!&ndash;                    </div>&ndash;&gt;-->
<!--                </div>-->
...
<!--                </div>-->
<!--&lt;!&ndash;                <div class="load wow fadeInUp">&ndash;&gt;-->
<!--&lt;!&ndash;                    <a>loading more series</a>&ndash;&gt;-->
<!--&lt;!&ndash;                </div>&ndash;&gt;-->
<!--            </div>-->
<!--        </div>-->
